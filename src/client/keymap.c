...
// Common key mappings (simplified - in real implementation would need complete mapping)
static const KeyMapping keymap[] = {
    ...
    // Row 5
    {15, VK_TAB}, {29, VK_CONTROL}, {42, VK_LSHIFT},
    {56, VK_LMENU}, {57, VK_SPACE}, {58, VK_CAPITAL},
    {69, VK_NUMLOCK}, {70, VK_SCROLL}, {83, VK_DELETE},
    ...
    {78, VK_ADD}, {96, VK_SEPARATOR},

    // Modifiers
    {97, VK_CONTROL}, {100, VK_RMENU}, {102, VK_HOME},
    {103, VK_UP}, {104, VK_PRIOR}, {105, VK_LEFT},
    {106, VK_RIGHT}, {107, VK_END}, {108, VK_DOWN},
    {109, VK_NEXT}, {110, VK_INSERT}, {111, VK_DELETE},

    // Additional keys
    {86, VK_OEM_102}, {110, VK_DECIMAL}, {125, VK_LWIN},
    {126, VK_RWIN}, {127, VK_APPS},
};
