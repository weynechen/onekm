...
In our case, we want to access `/dev/ttyACM0`, `/dev/ttyACM0` and `/dev/ttyACM1`

`/dev/ttyACM0`: Major 188, Minor 0
``` sh
peter@BrnoRPIG007:~ $ ls -l /dev/ttyACM0
crw-rw-rw- 1 root dialout 188, 0 Nov 12 11:08 /dev/ttyACM0
```
